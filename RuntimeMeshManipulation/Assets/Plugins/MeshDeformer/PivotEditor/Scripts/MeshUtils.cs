...
namespace Battlehub.MeshTools
{
    public static partial class MeshUtils
    {
        ...
        public static Mesh ExtractSubmesh(Mesh mesh, int submeshIndex)
        {
            ...
            if (uv5.Length == vertices.Length)
            {
                Vector2[] newuv5 = new Vector2[newIndex];
                foreach (KeyValuePair<int, int> kvp in remapping)
                {
                    newuv5[kvp.Value] = uv5[kvp.Key];
                }
                result.uv5 = newuv5;
            }
            else
            {
                if (uv5.Length != 0)
                {
                    Debug.LogWarning("uv5.Length != vertices.Length");
                }
            }

            Vector2[] uv6 = mesh.uv6;
            if (uv6.Length == vertices.Length)
            {
                Vector2[] newuv6 = new Vector2[newIndex];
                foreach (KeyValuePair<int, int> kvp in remapping)
                {
                    newuv6[kvp.Value] = uv6[kvp.Key];
                }
                result.uv6 = newuv6;
            }
            else
            {
                if (uv6.Length != 0)
                {
                    Debug.LogWarning("uv6.Length != vertices.Length");
                }
            }

            Vector2[] uv7 = mesh.uv7;
            if (uv7.Length == vertices.Length)
            {
                Vector2[] newuv7 = new Vector2[newIndex];
                foreach (KeyValuePair<int, int> kvp in remapping)
                {
                    newuv7[kvp.Value] = uv7[kvp.Key];
                }
                result.uv7 = newuv7;
            }
            else
            {
                if (uv7.Length != 0)
                {
                    Debug.LogWarning("uv7.Length != vertices.Length");
                }
            }

            Vector2[] uv8 = mesh.uv8;
            if (uv8.Length == vertices.Length)
            {
                Vector2[] newuv8 = new Vector2[newIndex];
                foreach (KeyValuePair<int, int> kvp in remapping)
                {
                    newuv8[kvp.Value] = uv8[kvp.Key];
                }
                result.uv8 = newuv8;
            }
            else
            {
                if (uv8.Length != 0)
                {
                    Debug.LogWarning("uv8.Length != vertices.Length");
                }
            }
            */
