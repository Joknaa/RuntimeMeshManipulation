    ...
    public class NonConvexColliderComponentEditor : UnityEditor.Editor {
        ...
        private void DrawParametersGUI(SerializedProperty m_parameters) {
            ...
            if (genSettingsOptionIndx == 3) {
                ...
                m_parameters_pca.boolValue =
                    EditorGUILayout.Toggle(new GUIContent("Normalization", "Enable / disable normalizing the mesh before applying the convex decomposition. Default = False"),
                        m_parameters_pca.boolValue);
